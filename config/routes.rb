...
Rails.application.routes.draw do
  ...
  # Commented out routes for PACIO, kept routes for PHFIC
  ...
  resources :encounters,           only: [:index, :show, :new]
  ...
  # NOTE: PHFIC resources without routes: specimen, location

  # Show capability statement of FHIR server its connected to
